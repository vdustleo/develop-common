...
def parse_excel(filename):
    ...
    for i in range(START, nrows):
        id, du, dt, owner, src, cv_id, reviewer, post, edu, it_age, tel, email, x1, x2, x3 = table.row_values(i)
        try:
            print "++", id, du, getdate(dt), owner, src
            print "==", cv_id, src, reviewer, post
        except:
            pass
